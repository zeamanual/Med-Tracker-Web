...
import {
  addAllergy,
  fetchAllergies,
  resetAllAllegyStatus,
} from "../state/slices/allergy";
import {
  addDiagnoses,
  fetchDiagnoses,
  resetAllDiagnosesStatus,
} from "../state/slices/diagnoses";
import {
  addMedicine,
  fetchMedicines,
  resetAllMedicineStatus,
} from "../state/slices/medicine";
import {
  addVaccine,
  fetchVaccines,
  resetAllVaccineStatus,
} from "../state/slices/vaccine";
...
function Add() {
  ...
  let loading =
    vaccine.loading || medicine.loading || diagnoses.loading || allergy.loading;
  let errorMsg =
    vaccine.errorMsg ||
    medicine.errorMsg ||
    diagnoses.errorMsg ||
      ...
      >
        <Box py={2} display="flex" alignItems="center">
          ...
          <Typography
            sx={{ paddingLeft: "1em" }}
            variant="h6"
          >{`Add ${currentPageName}`}</Typography>
        </Box>
