...
function ProfileUpdate() {
  ...
  let handleFirstNameChange = (e) => {
    ...
    if (value.length < 4) {
      setFieldsValue((previousValue) => ({
        ...previousValue,
        firstName: {
          ...fieldsValue.firstName,
          msg: "First name must be at least 4 characters",
  ...
  let handleLastNameChange = (e) => {
    ...
    if (value.length < 4) {
      setFieldsValue((previousValue) => ({
        ...previousValue,
        lastName: {
          ...fieldsValue.lastName,
          msg: "Last name must be at least 4 characters",
          value: e.target.value,
        },
      }));
      return false;
  ...
  let handleSSNChange = (e) => {
    ...
    if (!value) {
      setFieldsValue((previousValue) => ({
        ...
        ssn: {
          ...fieldsValue.ssn,
          msg: "Social security number can not be empty ",
          value: e.target.value,
        },
      }));
      return false;
  ...
  let handleInsuraceCompany = (e) => {
    ...
    if (!value) {
      setFieldsValue((previousValue) => ({
        ...previousValue,
        insuranceCompany: {
          ...fieldsValue.insuranceCompany,
          msg: "Insurance company name can not be empty ",
          value: e.target.value,
        },
      }));
      return false;
    ...
    if (!value) {
      setFieldsValue((previousValue) => ({
        ...
        emergencyContact1Name: {
          ...fieldsValue.emergencyContact1Name,
    ...
    if (!value) {
      setFieldsValue((previousValue) => ({
        ...
        emergencyContact1phone: {
          ...fieldsValue.emergencyContact1phone,
    ...
    if (!value) {
      setFieldsValue((previousValue) => ({
        ...
        emergencyContact1relation: {
          ...fieldsValue.emergencyContact1relation,
          msg: "Relation can not be empty ",
          value: e.target.value,
        },
      }));
      return false;
  ...
  let [fieldsValue, setFieldsValue] = React.useState({
    ...
    insuranceType: {
      value: "",
      msg: "",
      changeHandler: handleInsuraTypeChange,
    },
    insuranceCompany: {
      value: "",
      msg: "",
      changeHandler: handleInsuraceCompany,
    },
    policyNumber: {
      value: "",
      msg: "",
      changeHandler: noValidationChangeHanlder,
    },
    alarmTelephone: {
      value: "",
      msg: "",
    ...
    emergencyContact1Name: {
      value: "",
      msg: "",
      changeHandler: handleEmerContactNameChange,
    },
    ...
    emergencyContact1phone: {
      value: "",
      msg: "",
      changeHandler: handleEmerContactPhoneChange,
    },
    ...
    emergencyContact1relation: {
      value: "",
      msg: "",
      changeHandler: handleEmerContactRelationChange,
    },
  ...
  if (userObj && !fetchedDataUsed) {
    setFieldsValue((preValue) => {
      return {
        ...
        dob: {
          ...preValue.dob,
          value: new Date(userObj?.dateOfBirth).toISOString().substring(0, 10),
          msg: "",
          changeHandler: handleDoBChange,
        },
        gender: {
          ...preValue.gender,
        ...
        ssn: {
          ...
          value: userObj?.zip,
          msg: "",
          changeHandler: handleSSNChange,
        },
        nationality: {
          ...preValue.nationality,
          value: userObj?.nationality,
          msg: "",
          changeHandler: handleNationalityChange,
        },
        tlf: {
          ...preValue.tlf,
          value: userObj?.telephoneNumber,
          msg: "",
          changeHandler: handleTlfChange,
        },
        organDonor: {
          ...preValue.organDonor,
          value: Boolean(userObj?.organDonor) ? "yes" : "no",
          msg: "",
          changeHandler: handleOrganDonorChange,
        },
        postnr: {
          ...preValue.postnr,
          value: userObj?.zip,
          msg: "",
          changeHandler: handlePostnrChange,
        },
        city: {
          ...preValue.city,
          value: userObj?.city,
        ...
        land: {
          ...
          msg: "",
          changeHandler: handleLandChange,
        },
        street: {
          ...preValue.street,
        ...
        insuranceType: {
          ...preValue.insuranceType,
          value: userObj?.insuranceType,
          msg: "",
          changeHandler: handleInsuraTypeChange,
        },
        insuranceCompany: {
          ...preValue.insuranceCompany,
          value: userObj?.insuranceCompany,
          msg: "",
          changeHandler: handleInsuraceCompany,
        },
        policyNumber: {
          ...preValue.policyNumber,
          value: userObj?.policyNumber,
          msg: "",
          changeHandler: noValidationChangeHanlder,
        },
        alarmTelephone: {
          ...preValue.alarmTelephone,
          value: userObj?.emergencyPhone,
          msg: "",
          changeHandler: noValidationChangeHanlder,
        },
        emergencyContact1Name: {
          ...preValue.emergencyContact1Name,
          value: userObj?.emergencyContactName,
          msg: "",
          changeHandler: handleEmerContactNameChange,
        },
        emergencyContact2Name: {
        ...
        emergencyContact1phone: {
          ...preValue.emergencyContact1phone,
          value: userObj?.emergencyContactPhoneNo,
          msg: "",
          changeHandler: handleEmerContactPhoneChange,
        },
        emergencyContact2phone: {
        ...
        emergencyContact1relation: {
          ...preValue.emergencyContact1relation,
          value: userObj?.relationship,
          msg: "",
          changeHandler: handleEmerContactRelationChange,
        },
        emergencyContact2relation: {
  ...
  let formSubmitHandler = (e) => {
    ...
    for (let fieldName of Object.keys(fieldsValue)) {
      let isFieldValid = fieldsValue[fieldName].changeHandler({
        target: { value: fieldsValue[fieldName].value },
      });
      if (!isFieldValid) {
        isFormValid = false;
      }
  ...
  return (
    <Box bgcolor="#f8f8f8" display="flex" justifyContent="center">
      ...
      <Modal
        open={
          userState.profileUpdate.loading ||
      ...
      >
        ...
        >
          {userState.profileUpdate.errorMsg && (
            <Alert severity="error">{userState.profileUpdate.errorMsg}</Alert>
          )}
          {userState.profileUpdate.loading && (
        ...
        >
          ...
          <Box m={2}>
            ...
            <Box my={2} bgcolor="white">
              <TextField
                fullWidth={true}
                value={fieldsValue.firstName.value}
                onChange={fieldsValue.firstName.changeHandler}
                size="small"
                label="First Name"
              ></TextField>
            </Box>
            {fieldsValue.firstName.msg ? (
            ...
            <Box my={2} bgcolor="white">
              <TextField
                fullWidth={true}
                value={fieldsValue.lastName.value}
                onChange={fieldsValue.lastName.changeHandler}
                size="small"
                label="Last Name"
              ></TextField>
            </Box>
            {fieldsValue.lastName.msg ? (
              <Alert sx={{ padding: 0, marginTop: 1 }} severity="error">
                {fieldsValue.lastName.msg}
              </Alert>
            ) : (
              ...
              <Box mt={2} flexGrow={1}>
                <Box bgcolor="white" flexGrow={1}>
                  <TextField
                    ...
                    fullWidth={true}
                    value={fieldsValue.dob.value}
                    onChange={fieldsValue.dob.changeHandler}
                    size="small"
                    label="Date of Birth"
                  ></TextField>
                </Box>
              ...
              <Box mt={2} flexGrow={2}>
                <Box bgcolor="white" flexGrow={1} ml={1}>
                  <TextField
                    fullWidth={true}
                    select
                    value={fieldsValue.gender.value}
                    onChange={fieldsValue.gender.changeHandler}
                    size="small"
                    label="Gender"
                  >
            ...
            <Box my={2} bgcolor="white">
              <TextField
                fullWidth={true}
                value={fieldsValue.ssn.value}
                type="number"
                onChange={fieldsValue.ssn.changeHandler}
                size="small"
            ...
            <Box my={2} bgcolor="white">
              <TextField
                fullWidth={true}
                value={fieldsValue.nationality.value}
                onChange={fieldsValue.nationality.changeHandler}
                size="small"
                label="Nationality"
              ></TextField>
            </Box>
            {fieldsValue.nationality.msg ? (
              <Alert sx={{ padding: 0, marginTop: 1 }} severity="error">
                {fieldsValue.nationality.msg}
              </Alert>
            ) : (
            ...
            <Box my={2} bgcolor="white">
              <TextField
                fullWidth={true}
                type="number"
                value={fieldsValue.tlf.value}
                onChange={fieldsValue.tlf.changeHandler}
                size="small"
                label="Tlf nr"
              ></TextField>
            </Box>
            ...
            <Box my={0.5} bgcolor="white">
              <TextField
                fullWidth={true}
                select
                value={fieldsValue.organDonor.value}
                onChange={fieldsValue.organDonor.changeHandler}
                size="small"
                label=""
              >
            ...
            <Typography color={"gray"}>
              Healthcare Proffessionals will be required to ask family to
            ...
            <Typography variant="h4">Personal info</Typography>
            <Typography color={"gray"}>
              Fill the address you want us to send the card to. The address will
              not appear on the emergency card
            </Typography>
            <Box display={"flex"} justifyContent="space-between">
              <Box mt={2} flexGrow={1}>
                <Box bgcolor="white" flexGrow={1}>
                  <TextField
                    fullWidth={true}
                    type="number"
                    value={fieldsValue.postnr.value}
                    onChange={fieldsValue.postnr.changeHandler}
                    size="small"
                    label="Postnr./-sted"
                  ></TextField>
                </Box>
                {fieldsValue.postnr.msg ? (
                  <Alert sx={{ padding: 0, marginTop: 1 }} severity="error">
                    {fieldsValue.postnr.msg}
                  </Alert>
                ) : (
              ...
              <Box flexGrow={1} ml={1}>
                <Box mt={2} bgcolor="white" flexGrow={1} ml={1}>
                  <TextField
                    ...
                    onChange={fieldsValue.city.changeHandler}
                    size="small"
                    label="City"
                  ></TextField>
                </Box>
                {fieldsValue.city.msg ? (
                  <Alert sx={{ padding: 0, marginTop: 1 }} severity="error">
                    {fieldsValue.city.msg}
                  </Alert>
                ) : (
            ...
            <Box my={2} bgcolor="white">
              <TextField
                fullWidth={true}
                select
                value={fieldsValue.land.value}
                onChange={fieldsValue.land.changeHandler}
                size="small"
                label="Land"
              >
            ...
            <Box my={2} bgcolor="white">
              <TextField
                fullWidth={true}
                value={fieldsValue.street.value}
                onChange={fieldsValue.street.changeHandler}
                size="small"
                label="Street Address"
              ></TextField>
            </Box>
            {fieldsValue.street.msg ? (
              <Alert sx={{ padding: 0, marginTop: 1 }} severity="error">
                {fieldsValue.street.msg}
              </Alert>
            ) : (
            ...
            <Box my={2} bgcolor="white">
              <TextField
                ...
                fullWidth={true}
                select
                value={fieldsValue.insuranceType.value}
                onChange={fieldsValue.insuranceType.changeHandler}
                size="small"
            ...
            <Box my={2} bgcolor="white">
              <TextField
                fullWidth={true}
                value={fieldsValue.insuranceCompany.value}
                onChange={fieldsValue.insuranceCompany.changeHandler}
                size="small"
                label="Insurance Company"
              ></TextField>
            </Box>
            {fieldsValue.insuranceCompany.msg ? (
              <Alert sx={{ padding: 0, marginTop: 1 }} severity="error">
                {fieldsValue.insuranceCompany.msg}
              </Alert>
            ) : (
            ...
            <Box my={2} bgcolor="white">
              <TextField
                fullWidth={true}
                value={fieldsValue.policyNumber.value}
                onChange={(e) =>
                  fieldsValue.policyNumber.changeHandler(e, "policyNumber")
                }
                size="small"
            ...
            <Box my={2} bgcolor="white">
              <TextField
                fullWidth={true}
                value={fieldsValue.alarmTelephone.value}
                onChange={(e) =>
                  fieldsValue.alarmTelephone.changeHandler(e, "alarmTelephone")
                }
                size="small"
                label="Alarm Telephone( Optional )"
              ></TextField>
            </Box>
            ...
            <Box my={2} bgcolor="white">
              <TextField
                fullWidth={true}
                value={fieldsValue.emergencyContact1Name.value}
                onChange={fieldsValue.emergencyContact1Name.changeHandler}
                size="small"
                label="Name"
              ></TextField>
            </Box>
            {fieldsValue.emergencyContact1Name.msg ? (
              <Alert sx={{ padding: 0, marginTop: 1 }} severity="error">
                {fieldsValue.emergencyContact1Name.msg}
              </Alert>
            ) : (
            ...
            <Box mt={1} display={"flex"} justifyContent="space-between">
              <Box flexGrow={1}>
                <Box bgcolor="white" flexGrow={1}>
                  <TextField
                    fullWidth={true}
                    value={fieldsValue.emergencyContact1phone.value}
                    onChange={fieldsValue.emergencyContact1phone.changeHandler}
                    size="small"
                    label="Phone number"
                  ></TextField>
                </Box>
                {fieldsValue.emergencyContact1phone.msg ? (
                  <Alert sx={{ padding: 0, marginTop: 1 }} severity="error">
                    {fieldsValue.emergencyContact1phone.msg}
                  </Alert>
                ) : (
              ...
              <Box flexGrow={1} ml={1}>
                <Box bgcolor="white" flexGrow={1} ml={1}>
                  <TextField
                    fullWidth={true}
                    value={fieldsValue.emergencyContact1relation.value}
                    onChange={
                      fieldsValue.emergencyContact1relation.changeHandler
                    }
                    size="small"
                    label="Relationship"
                  ></TextField>
                </Box>
                {fieldsValue.emergencyContact1relation.msg ? (
                  <Alert sx={{ padding: 0, marginTop: 1 }} severity="error">
                    {fieldsValue.emergencyContact1relation.msg}
                  </Alert>
                ) : (
            ...
            <Box my={2} bgcolor="white">
              <TextField
                fullWidth={true}
                value={fieldsValue.emergencyContact2Name.value}
                onChange={(e) =>
                  fieldsValue.emergencyContact2Name.changeHandler(
                    e,
                    "emergencyContact2Name"
                  )
                }
            ...
            {fieldsValue.emergencyContact2Name.msg ? (
              <Alert sx={{ padding: 0, marginTop: 1 }} severity="error">
                {fieldsValue.emergencyContact2Name.msg}
              </Alert>
            ) : (
            ...
            <Box display={"flex"} justifyContent="space-between">
              <Box flexGrow={1}>
                <Box bgcolor="white" flexGrow={1}>
                  <TextField
                    fullWidth={true}
                    value={fieldsValue.emergencyContact2phone.value}
                    onChange={(e) =>
                      fieldsValue.emergencyContact2phone.changeHandler(
                        e,
                        "emergencyContact2phone"
                      )
                    }
                ...
                {fieldsValue.emergencyContact2phone.msg ? (
                  <Alert sx={{ padding: 0, marginTop: 1 }} severity="error">
                    {fieldsValue.emergencyContact2phone.msg}
                  </Alert>
                ) : (
              ...
              <Box flexGrow={1} ml={1}>
                <Box bgcolor="white" flexGrow={1} ml={1}>
                  <TextField
                    fullWidth={true}
                    value={fieldsValue.emergencyContact2relation.value}
                    onChange={(e) =>
                      fieldsValue.emergencyContact2relation.changeHandler(
                        e,
                        "emergencyContact2relation"
                      )
                    }
              ...
              {fieldsValue.emergencyContact2relation.msg ? (
                <Alert sx={{ padding: 0, marginTop: 1 }} severity="error">
                  {fieldsValue.emergencyContact2relation.msg}
                </Alert>
              ) : (
            ...
            <Box my={2} mb={6} bgcolor="white">
              <TextField
                ...
                multiline
                rows={5}
                value={fieldsValue.other.value}
                onChange={(e) => fieldsValue.other.changeHandler(e, "other")}
                size="small"
                label=""
