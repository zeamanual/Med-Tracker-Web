...
function Login() {
  ...
  let formSubmitHandler = (e) => {
    ...
    if (
      ...
      Boolean(loginDetails.email) &&
      !errorDetails.password.hasError &&
      Boolean(loginDetails.password)
    ) {
      dispatch(
        userLogin({
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {userState.userLogIn.errorMsg && (
            <Alert severity="error">{userState.userLogIn.errorMsg}</Alert>
          )}
        ...
        >
          ...
          <Box width={"100%"} borderRadius={30} overflow="hidden">
            <Button
              ...
              sx={{
                bgcolor:
                  !errorDetails.isFormValid || userState.userLogIn.loading
                    ? "lightBlue"
                    : "primary",
                padding: "0.7em",
              }}
