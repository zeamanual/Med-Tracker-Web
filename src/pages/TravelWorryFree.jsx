  ...
  return (
      ...
      <main>
        ...
        <div>
          ...
          You will have your own personal profile
          which can be accessed via app or
          browser. There is a built in translation
          function for 19 languages which will ease
          communication in relevant local terms.
          Skip Tour          
          </Typography>
          </Container>
        </div>
