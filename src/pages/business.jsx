    ...
    <>
      ...
      />
        ...
        <Box bgcolor={"#f8f8f8"} py={"10em"} width={"100%"}>
                <Typography textAlign={"center"} width="60%"  mx={"auto"} fontWeight="800" mb="35px" variant="h3">
                8 REASONS TO ORDER WORLD MEDICAL CARD®
                </Typography>
                <Typography m="auto" width={"75%"} textAlign={"center"} >
                World Medical Card® is always available via app, PC or a physical card. You can upload your personal medical information, coded so that you are understood by healthcare professionals – anywhere in the world, around the clock.<br />  
<br />
Let your employees try World Medical Card Business Solutions<br />  

You choose what information you want, including:<br />  <br />

Covid vaccine documentation<br />  

Important allergies<br />  

Important medications you must have<br />  

Contact information for relatives<br />  

Emergency button for relatives<br />  
