      ...
      <Box ref={image} sx={{ mb: 4 }}>
        <Box sx={{ backgroundColor: "white", borderRadius: "1.5em" }}>
          <Box
            ...
            boxShadow={{
              xs: "1px 1px 7px  #a3a3a3",
              md: "0px 1px 2px  lightGray",
            }}
            sx={{
              overflow: "hidden",
          ...
          >
            ...
            >
                  ...
                  >
                    ...
                    >
                      {singleData.length === 0
                        ...
                        : `${singleData.length} ${
                            singleData.length === 1 ? "item" : "items"
                          }: ${
                            index == 4
                              ? singleData[0].title
                              : singleData[0].name
              ...
              <AccordionDetails>
                <Divider />
                <Box sx={{ py: 2, maxHeight: "70vh", overflowY: "scroll" }}>
                  {index === 4 ? (
                    <ListDocuments data={singleData} />
                  ) : (
                ...
                {open ? (
                  <RemoveSnackBar open={open} handleClose={handleClose} />
                ) : (
                  <></>
                )}
                <Box
